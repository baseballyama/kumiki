<!--
  @component NumberField.Decrement — step-down button.
...
<script lang="ts" module>
  ...
  /**
   * NumberField.Decrement — step-down button.
   *
   * Require either `children` (the button label rendered as content, e.g. `−`)
   * or `aria-label` (e.g. `"Decrease"`) so every step button has an accessible
   * name.
   *
...
<button type="button" data-component-part="decrement" {...rest} {@attach controller.decrement_}>
