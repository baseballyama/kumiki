...
- **Performance.** Tight brotli budgets enforced in CI per subpath: 500 B per primitive, 1.5 KB per machine, 4.5 KB for Combobox, etc. See [bundle budget](docs/design/09-bundle-budget.md).
