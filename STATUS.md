...
**Totals:** machines 340, headless 271, runtime 15, primitives 46, cli 5 — **677 unit tests across 9 packages** (plus 76 APG keyboard cases in Playwright). **109 microbenchmarks** at `/bench`.
