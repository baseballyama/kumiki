...
## 着手順（次の 2 週間） — 2026-05-10 更新（C-2 / D-2 a11y matrix / 架構的削減 ADR 起票 完了後）

> C-2 atelier shape 統一 + D-2 a11y feature matrix + ADR 0019/0020/0021 (Proposed) が完了。Atelier GA 残りは C-5 visual regression、D-2 bundle 列は Headless UI 追加 + 競合自動再測定パイプライン整備が残課題。
