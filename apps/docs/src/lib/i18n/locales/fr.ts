...
export const dict: DocDict = {
  ...
  components: {
    ...
    layerL4: 'L4 — Compound',
    layerL5: 'L5 — Atelier',
    familyTitle: 'Ce composant, couche par couche',
    familyLede:
      'Kumiki livre le même composant à plusieurs couches. Choisissez celle qui offre le bon équilibre entre liberté et comportement prêt à l’emploi pour votre système.',
    familyWhen: 'Quand utiliser cette couche',
    familyCurrent: 'en cours de consultation',
    layerWhen: [
      'Types uniquement. N’apparaît jamais dans la pile d’exécution.',
      'Briques pures, sans framework (focus-trap, id, live-region). Fonctionnent partout.',
      'Machines à états pures (FSM). Sans DOM. S’exécutent côté serveur, Vitest, Worker. Pour ne récupérer que le comportement.',
      'Factories `{@attach}` Svelte 5. Branchent ARIA / clavier / focus sur n’importe quel nœud DOM. **Idéal quand vous voulez un contrôle total du balisage et des styles.**',
  ...
  sidebar: {
    ...
    styling: 'Style',
    components: 'Composants',
    layer0: 'Layer 0 — Types',
    layer1: 'Layer 1 — Primitives',
    layer2: 'Layer 2 — Machines',
    layer3: 'Layer 3 — Headless',
    layer4: 'Layer 4 — Composants',
