...
export const dict: DocDict = {
  ...
  components: {
    ...
    layerL4: 'L4 — Compound',
    layerL5: 'L5 — Atelier',
    familyTitle: 'This component, layer by layer',
    familyLede:
      'Kumiki ships the same component across multiple layers. Pick the layer that gives you the right balance of freedom and out-of-the-box behavior for your system.',
    familyWhen: 'When to use this layer',
    familyCurrent: 'currently viewing',
    layerWhen: [
      'Types only. Never appears in your runtime stack.',
      'Framework-agnostic, pure-function building blocks (focus-trap, id, live-region). Run anywhere — Node, browser, non-Svelte frameworks.',
