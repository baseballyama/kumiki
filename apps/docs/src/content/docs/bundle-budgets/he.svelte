...
>
  ...
  <p>
    ...
    <a href={resolve('/sizes')}>/sizes</a>; השוואות מול מתחרים ב-
  ...
  <h2>למה זה בתיעוד</h2>
  <p>
    כי לסוקרים מגיע לדעת. PR שמעלה את Combobox מ-4.5 KB ל-4.8 KB אינה שינוי קטן — היא החלטה שמחייבת
    ADR מתאים. המספר גלוי לצרכנים; גם המשמעת חייבת להיות גלויה.
  </p>
</Prose>
