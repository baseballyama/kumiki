...
<style>
  ...
  <ul>
    <li>
      <a href={resolve('/docs/layers-by-example')}>Couches par l'exemple</a> — comment le code utilisateur
      diffère en Layer 2/3/4/5.
    </li>
    <li>
    ...
    <li>
      <a href={resolve('/docs/i18n')}>i18n et RTL</a> — utiliser <code>data-direction</code> pour le style
      RTL.
    </li>
  </ul>
</Prose>
